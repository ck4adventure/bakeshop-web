		...
		<div className='flex flex-col justify-center items-center m-0'>
			...
			<header className="w-full bg-white shadow flex items-center justify-between px-8 py-4">
				<div className="flex items-center gap-2">
					...
					<span className="text-xl font-bold text-blue-900">Bakeshop</span>
				</div>
			...
			<main className="w-full max-w-4xl mt-8 flex flex-col gap-12">
				...
				<section className="flex flex-col items-center text-center py-12 bg-blue-50 rounded-lg shadow">
					...
					/>
					<h1 className="text-4xl font-bold text-blue-900 mb-2">Welcome to Our Business</h1>
					<p className="text-lg text-blue-700 mb-4">
						We help you achieve your goals with our amazing products and services.
					</p>
				...
				<section className="grid grid-cols-1 md:grid-cols-3 gap-6" id="features">
					<div className="bg-white p-6 rounded shadow text-center">
						...
						<p className="text-blue-600">Short description of the first feature.</p>
					</div>
					<div className="bg-white p-6 rounded shadow text-center">
						<h2 className="font-semibold text-blue-800 mb-2">Feature Two</h2>
						<p className="text-blue-600">Short description of the second feature.</p>
					</div>
					<div className="bg-white p-6 rounded shadow text-center">
						<h2 className="font-semibold text-blue-800 mb-2">Feature Three</h2>
						<p className="text-blue-600">Short description of the third feature.</p>
					</div>
				</section>
